...
- `send-license` et `itch-webhook` sont retirés : réponse HTTP 410 avec explication du nouveau parcours, sans génération ni divulgation de clé. Aucun webhook itch.io n'est nécessaire.
